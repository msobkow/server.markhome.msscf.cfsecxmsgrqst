...
/*
 *	CFSecXMsgRqstSecSessionPageAll XML SAX Element  implementation
 *	for SecSession.
 */
public class CFSecXMsgRqstSecSessionPageAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecSessionPageAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
