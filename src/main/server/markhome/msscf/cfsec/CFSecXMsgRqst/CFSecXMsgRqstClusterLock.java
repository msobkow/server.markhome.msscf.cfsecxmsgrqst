...
/*
 *	CFSecXMsgRqstClusterLock XML SAX Element  implementation
 *	for Cluster.
 */
public class CFSecXMsgRqstClusterLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstClusterLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredId( natId );
			// Lock the object
			ICFSecClusterObj locked = ((ICFSecClusterObj)schemaObj.getClusterTableObj().lockCluster( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgClusterMessageFormatter.formatClusterRspnLocked( "\n\t\t\t", locked.getClusterBuff() )
				+	"\n"
