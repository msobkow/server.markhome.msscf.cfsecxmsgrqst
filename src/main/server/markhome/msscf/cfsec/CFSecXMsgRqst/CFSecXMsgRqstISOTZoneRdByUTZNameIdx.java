...
/*
 *	CFSecXMsgRqstISOTZoneRdBy XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFSecXMsgRqstISOTZoneRdByUTZNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOTZoneRdByUTZNameIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecISOTZoneObj read = ((ICFSecISOTZoneObj)schemaObj.getISOTZoneTableObj().readISOTZoneByUTZNameIdx( natTZName,
				true ));
			if( read != null ) {
