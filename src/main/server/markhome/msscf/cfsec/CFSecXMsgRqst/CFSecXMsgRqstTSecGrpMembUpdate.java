...
/*
 *	CFSecXMsgRqstTSecGrpMembUpdate XML SAX Element  implementation
 *	for TSecGrpMemb.
 */
public class CFSecXMsgRqstTSecGrpMembUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGrpMembUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecTSecGrpMembPKey pkey = ((ICFSecSchema)schemaObj.getBackingStore()).getFactoryTSecGrpMemb().newPKey();
			...
			// Read the instance
			ICFSecTSecGrpMembObj origBuff = ((ICFSecTSecGrpMembObj)schemaObj.getTSecGrpMembTableObj().readTSecGrpMemb( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecTSecGrpMembEditObj editBuff = (ICFSecTSecGrpMembEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRspnUpdated( "\n\t\t\t", origBuff.getTSecGrpMembBuff() )
					+	"\n"
