...
/*
 *	CFSecXMsgRqstServiceUpdate XML SAX Element  implementation
 *	for Service.
 */
public class CFSecXMsgRqstServiceUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFSecServiceObj origBuff = ((ICFSecServiceObj)schemaObj.getServiceTableObj().readService( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecServiceEditObj editBuff = (ICFSecServiceEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgServiceMessageFormatter.formatServiceRspnUpdated( "\n\t\t\t", origBuff.getServiceBuff() )
					+	"\n"
