...
/*
 *	CFSecXMsgRqstSecAppLock XML SAX Element  implementation
 *	for SecApp.
 */
public class CFSecXMsgRqstSecAppLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecAppLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecAppId( natSecAppId );
			// Lock the object
			ICFSecSecAppObj locked = ((ICFSecSecAppObj)schemaObj.getSecAppTableObj().lockSecApp( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecAppMessageFormatter.formatSecAppRspnLocked( "\n\t\t\t", locked.getSecAppBuff() )
				+	"\n"
