...
/*
 *	CFSecXMsgRqstServiceTypeUpdate XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFSecXMsgRqstServiceTypeUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceTypeUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFSecServiceTypeObj origBuff = ((ICFSecServiceTypeObj)schemaObj.getServiceTypeTableObj().readServiceType( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecServiceTypeEditObj editBuff = (ICFSecServiceTypeEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRspnUpdated( "\n\t\t\t", origBuff.getServiceTypeBuff() )
					+	"\n"
