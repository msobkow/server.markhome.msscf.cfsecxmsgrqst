...
/*
 *	CFSecXMsgRqstHostNodeLock XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRqstHostNodeLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstHostNodeLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredHostNodeId( natHostNodeId );
			// Lock the object
			ICFSecHostNodeObj locked = ((ICFSecHostNodeObj)schemaObj.getHostNodeTableObj().lockHostNode( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRspnLocked( "\n\t\t\t", locked.getHostNodeBuff() )
				+	"\n"
