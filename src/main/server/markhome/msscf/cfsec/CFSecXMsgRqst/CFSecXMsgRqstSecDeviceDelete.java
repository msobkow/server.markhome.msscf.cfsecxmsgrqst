...
/*
 *	CFSecXMsgRqstSecDeviceDelete XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFSecXMsgRqstSecDeviceDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecDeviceDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecSecDeviceObj read = ((ICFSecSecDeviceObj)schemaObj.getSecDeviceTableObj().readSecDevice( pkey ));
			if( read != null ) {
				if( read.getSecDeviceBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecSecDeviceEditObj editBuff = (ICFSecSecDeviceEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFSecXMsgSecDeviceMessageFormatter.formatSecDeviceRspnDeleted() +	"\n"
