...
/*
 *	CFSecXMsgRqstServiceTypeDelBy XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFSecXMsgRqstServiceTypeDelByUDescrIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceTypeDelByUDescrIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
