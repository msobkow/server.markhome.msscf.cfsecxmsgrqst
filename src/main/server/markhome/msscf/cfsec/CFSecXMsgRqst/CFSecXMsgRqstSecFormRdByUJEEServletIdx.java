 ...
 *	for SecForm.
 */
public class CFSecXMsgRqstSecFormRdByUJEEServletIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecFormRdByUJEEServletIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecSecFormObj read = ((ICFSecSecFormObj)schemaObj.getSecFormTableObj().readSecFormByUJEEServletIdx( natClusterId,
				natSecAppId,
