...
/*
 *	CFSecXMsgRqstSecAppPageBy XML SAX Element  implementation
 *	for SecApp.
 */
public class CFSecXMsgRqstSecAppPageByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecAppPageByClusterIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
