...
/*
 *	CFSecXMsgRqstServiceRead XML SAX Element  implementation
 *	for Service.
 */
public class CFSecXMsgRqstServiceRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecServicePKey pkey = ((ICFSecSchema)schemaObj.getBackingStore()).getFactoryService().newPKey();
			...
			ICFSecServiceObj read = ((ICFSecServiceObj)schemaObj.getServiceTableObj().readService( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgServiceMessageFormatter.formatServiceRspnSingleOpenTag()
					+	CFSecXMsgServiceMessageFormatter.formatServiceRspnDerivedRec( "\n\t\t", read.getServiceBuff() ) + "\n"
					+	"\t" + CFSecXMsgServiceMessageFormatter.formatServiceRspnSingleCloseTag()
