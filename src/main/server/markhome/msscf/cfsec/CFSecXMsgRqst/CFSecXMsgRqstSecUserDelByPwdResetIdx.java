...
/*
 *	CFSecXMsgRqstSecUserDelBy XML SAX Element  implementation
 *	for SecUser.
 */
public class CFSecXMsgRqstSecUserDelByPwdResetIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecUserDelByPwdResetIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecUserMessageFormatter.formatSecUserRspnDeleted() +	"\n"
