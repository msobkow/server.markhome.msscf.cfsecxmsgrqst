...
/*
 *	CFSecXMsgRqstISOLangLock XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFSecXMsgRqstISOLangLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOLangLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredISOLangId( natISOLangId );
			// Lock the object
			ICFSecISOLangObj locked = ((ICFSecISOLangObj)schemaObj.getISOLangTableObj().lockISOLang( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgISOLangMessageFormatter.formatISOLangRspnLocked( "\n\t\t\t", locked.getISOLangBuff() )
				+	"\n"
