...
/*
 *	CFSecXMsgRqstISOCcyRdBy XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFSecXMsgRqstISOCcyRdByCcyCdIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCcyRdByCcyCdIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecISOCcyObj read = ((ICFSecISOCcyObj)schemaObj.getISOCcyTableObj().readISOCcyByCcyCdIdx( natISOCode,
				true ));
			if( read != null ) {
