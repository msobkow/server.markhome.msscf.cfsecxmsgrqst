...
/*
 *	CFSecXMsgRqstTSecGrpIncUpdate XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFSecXMsgRqstTSecGrpIncUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGrpIncUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFSecTSecGrpIncObj origBuff = ((ICFSecTSecGrpIncObj)schemaObj.getTSecGrpIncTableObj().readTSecGrpInc( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecTSecGrpIncEditObj editBuff = (ICFSecTSecGrpIncEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRspnUpdated( "\n\t\t\t", origBuff.getTSecGrpIncBuff() )
					+	"\n"
