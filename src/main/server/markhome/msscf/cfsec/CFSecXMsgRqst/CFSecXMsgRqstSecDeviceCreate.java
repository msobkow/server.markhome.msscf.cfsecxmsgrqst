...
/*
 *	CFSecXMsgRqstSecDeviceCreate XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFSecXMsgRqstSecDeviceCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecDeviceCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecDeviceObj created = (ICFSecSecDeviceObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecDeviceMessageFormatter.formatSecDeviceRspnCreated( "\n\t\t\t", created.getSecDeviceBuff() )
				+	"\n"
