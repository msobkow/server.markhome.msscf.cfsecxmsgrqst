...
/*
 *	CFSecXMsgRqstSecGrpMembCreate XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFSecXMsgRqstSecGrpMembCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGrpMembCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecGrpMembObj created = (ICFSecSecGrpMembObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecGrpMembMessageFormatter.formatSecGrpMembRspnCreated( "\n\t\t\t", created.getSecGrpMembBuff() )
				+	"\n"
