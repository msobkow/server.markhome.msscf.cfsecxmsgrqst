...
/*
 *	CFSecXMsgRqstTSecGroupReadAll XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFSecXMsgRqstTSecGroupReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGroupReadAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
