...
/*
 *	CFSecXMsgRqstSecFormCreate XML SAX Element  implementation
 *	for SecForm.
 */
public class CFSecXMsgRqstSecFormCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecFormCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecFormObj created = (ICFSecSecFormObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecFormMessageFormatter.formatSecFormRspnCreated( "\n\t\t\t", created.getSecFormBuff() )
				+	"\n"
