...
/*
 *	CFSecXMsgRqstSysClusterLock XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFSecXMsgRqstSysClusterLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSysClusterLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSingletonId( natSingletonId );
			// Lock the object
			ICFSecSysClusterObj locked = ((ICFSecSysClusterObj)schemaObj.getSysClusterTableObj().lockSysCluster( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSysClusterMessageFormatter.formatSysClusterRspnLocked( "\n\t\t\t", locked.getSysClusterBuff() )
				+	"\n"
