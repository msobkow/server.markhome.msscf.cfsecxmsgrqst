...
/*
 *	CFSecXMsgRqstSecDeviceRead XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFSecXMsgRqstSecDeviceRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecDeviceRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecDeviceObj read = ((ICFSecSecDeviceObj)schemaObj.getSecDeviceTableObj().readSecDevice( pkey, true ));
			if( read != null ) {
