...
/*
 *	CFSecXMsgRqstServiceLock XML SAX Element  implementation
 *	for Service.
 */
public class CFSecXMsgRqstServiceLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredServiceId( natServiceId );
			// Lock the object
			ICFSecServiceObj locked = ((ICFSecServiceObj)schemaObj.getServiceTableObj().lockService( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgServiceMessageFormatter.formatServiceRspnLocked( "\n\t\t\t", locked.getServiceBuff() )
				+	"\n"
