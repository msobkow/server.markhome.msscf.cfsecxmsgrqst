...
/*
 *	CFSecXMsgRqstISOLangDelete XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFSecXMsgRqstISOLangDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOLangDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecISOLangObj read = ((ICFSecISOLangObj)schemaObj.getISOLangTableObj().readISOLang( pkey ));
			if( read != null ) {
				if( read.getISOLangBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecISOLangEditObj editBuff = (ICFSecISOLangEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFSecXMsgISOLangMessageFormatter.formatISOLangRspnDeleted() +	"\n"
