...
/*
 *	CFSecXMsgRqstServicePageAll XML SAX Element  implementation
 *	for Service.
 */
public class CFSecXMsgRqstServicePageAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServicePageAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
