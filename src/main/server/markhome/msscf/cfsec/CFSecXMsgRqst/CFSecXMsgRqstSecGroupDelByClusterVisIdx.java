...
/*
 *	CFSecXMsgRqstSecGroupDelBy XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFSecXMsgRqstSecGroupDelByClusterVisIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupDelByClusterVisIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
