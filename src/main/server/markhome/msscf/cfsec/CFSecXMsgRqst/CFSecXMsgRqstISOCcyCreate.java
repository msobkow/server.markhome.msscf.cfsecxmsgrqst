...
/*
 *	CFSecXMsgRqstISOCcyCreate XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFSecXMsgRqstISOCcyCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCcyCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecISOCcyObj created = (ICFSecISOCcyObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgISOCcyMessageFormatter.formatISOCcyRspnCreated( "\n\t\t\t", created.getISOCcyBuff() )
				+	"\n"
