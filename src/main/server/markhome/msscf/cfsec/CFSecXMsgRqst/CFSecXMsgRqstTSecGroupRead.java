...
/*
 *	CFSecXMsgRqstTSecGroupRead XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFSecXMsgRqstTSecGroupRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGroupRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecTSecGroupObj read = ((ICFSecTSecGroupObj)schemaObj.getTSecGroupTableObj().readTSecGroup( pkey, true ));
			if( read != null ) {
