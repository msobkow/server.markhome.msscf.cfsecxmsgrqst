...
/*
 *	CFSecXMsgRqstSecGroupRdBy XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFSecXMsgRqstSecGroupRdByUNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupRdByUNameIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecSecGroupObj read = ((ICFSecSecGroupObj)schemaObj.getSecGroupTableObj().readSecGroupByUNameIdx( natClusterId,
				natName,
				true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecGroupMessageFormatter.formatSecGroupRspnSingleOpenTag()
					+	CFSecXMsgSecGroupMessageFormatter.formatSecGroupRspnDerivedRec( "\n\t\t", read.getSecGroupBuff() ) + "\n"
					+	"\t" + CFSecXMsgSecGroupMessageFormatter.formatSecGroupRspnSingleCloseTag()
