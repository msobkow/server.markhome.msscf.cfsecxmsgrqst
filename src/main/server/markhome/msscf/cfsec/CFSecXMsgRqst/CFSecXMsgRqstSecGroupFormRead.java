...
/*
 *	CFSecXMsgRqstSecGroupFormRead XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFSecXMsgRqstSecGroupFormRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupFormRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecGroupFormObj read = ((ICFSecSecGroupFormObj)schemaObj.getSecGroupFormTableObj().readSecGroupForm( pkey, true ));
			if( read != null ) {
