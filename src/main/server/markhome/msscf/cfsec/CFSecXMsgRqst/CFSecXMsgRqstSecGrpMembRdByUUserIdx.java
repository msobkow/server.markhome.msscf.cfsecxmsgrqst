...
/*
 *	CFSecXMsgRqstSecGrpMembRdBy XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFSecXMsgRqstSecGrpMembRdByUUserIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGrpMembRdByUUserIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecSecGrpMembObj read = ((ICFSecSecGrpMembObj)schemaObj.getSecGrpMembTableObj().readSecGrpMembByUUserIdx( natClusterId,
				natSecGroupId,
				natSecUserId,
				true ));
			if( read != null ) {
