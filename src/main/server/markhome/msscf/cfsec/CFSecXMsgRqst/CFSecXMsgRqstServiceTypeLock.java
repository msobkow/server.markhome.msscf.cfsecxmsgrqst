...
/*
 *	CFSecXMsgRqstServiceTypeLock XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFSecXMsgRqstServiceTypeLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceTypeLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredServiceTypeId( natServiceTypeId );
			// Lock the object
			ICFSecServiceTypeObj locked = ((ICFSecServiceTypeObj)schemaObj.getServiceTypeTableObj().lockServiceType( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRspnLocked( "\n\t\t\t", locked.getServiceTypeBuff() )
				+	"\n"
