...
/*
 *	CFSecXMsgRqstTenantDelBy XML SAX Element  implementation
 *	for Tenant.
 */
public class CFSecXMsgRqstTenantDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTenantDelByClusterIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgTenantMessageFormatter.formatTenantRspnDeleted() +	"\n"
