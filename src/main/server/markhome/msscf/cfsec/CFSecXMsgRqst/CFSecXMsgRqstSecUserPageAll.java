...
/*
 *	CFSecXMsgRqstSecUserPageAll XML SAX Element  implementation
 *	for SecUser.
 */
public class CFSecXMsgRqstSecUserPageAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecUserPageAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
