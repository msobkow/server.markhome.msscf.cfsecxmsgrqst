...
/*
 *	CFSecXMsgRqstISOTZoneLock XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFSecXMsgRqstISOTZoneLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOTZoneLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredISOTZoneId( natISOTZoneId );
			// Lock the object
			ICFSecISOTZoneObj locked = ((ICFSecISOTZoneObj)schemaObj.getISOTZoneTableObj().lockISOTZone( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgISOTZoneMessageFormatter.formatISOTZoneRspnLocked( "\n\t\t\t", locked.getISOTZoneBuff() )
				+	"\n"
