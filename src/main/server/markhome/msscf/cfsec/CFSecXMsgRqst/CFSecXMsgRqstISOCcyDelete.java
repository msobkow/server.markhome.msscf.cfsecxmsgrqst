...
/*
 *	CFSecXMsgRqstISOCcyDelete XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFSecXMsgRqstISOCcyDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCcyDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecISOCcyObj read = ((ICFSecISOCcyObj)schemaObj.getISOCcyTableObj().readISOCcy( pkey ));
			if( read != null ) {
				if( read.getISOCcyBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecISOCcyEditObj editBuff = (ICFSecISOCcyEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFSecXMsgISOCcyMessageFormatter.formatISOCcyRspnDeleted() +	"\n"
