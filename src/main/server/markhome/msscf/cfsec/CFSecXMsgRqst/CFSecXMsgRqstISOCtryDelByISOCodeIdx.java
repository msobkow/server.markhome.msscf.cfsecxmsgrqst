...
/*
 *	CFSecXMsgRqstISOCtryDelBy XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFSecXMsgRqstISOCtryDelByISOCodeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCtryDelByISOCodeIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
