...
/*
 *	CFSecXMsgRqstHostNodeDelBy XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRqstHostNodeDelByHostNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstHostNodeDelByHostNameIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
