...
/*
 *	CFSecXMsgRqstSecGroupFormRdBy XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFSecXMsgRqstSecGroupFormRdByUFormIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupFormRdByUFormIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecSecGroupFormObj read = ((ICFSecSecGroupFormObj)schemaObj.getSecGroupFormTableObj().readSecGroupFormByUFormIdx( natClusterId,
				natSecGroupId,
				natSecFormId,
				true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnSingleOpenTag()
					+	CFSecXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnDerivedRec( "\n\t\t", read.getSecGroupFormBuff() ) + "\n"
					+	"\t" + CFSecXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnSingleCloseTag()
