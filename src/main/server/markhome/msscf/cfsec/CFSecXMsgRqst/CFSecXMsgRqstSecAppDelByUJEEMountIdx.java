...
/*
 *	CFSecXMsgRqstSecAppDelBy XML SAX Element  implementation
 *	for SecApp.
 */
public class CFSecXMsgRqstSecAppDelByUJEEMountIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecAppDelByUJEEMountIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
