...
/*
 *	CFSecXMsgRqstISOLangUpdate XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFSecXMsgRqstISOLangUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOLangUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFSecISOLangObj origBuff = ((ICFSecISOLangObj)schemaObj.getISOLangTableObj().readISOLang( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecISOLangEditObj editBuff = (ICFSecISOLangEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgISOLangMessageFormatter.formatISOLangRspnUpdated( "\n\t\t\t", origBuff.getISOLangBuff() )
					+	"\n"
