...
/*
 *	CFSecXMsgRqstSecGrpIncCreate XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFSecXMsgRqstSecGrpIncCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGrpIncCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecGrpIncObj created = (ICFSecSecGrpIncObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecGrpIncMessageFormatter.formatSecGrpIncRspnCreated( "\n\t\t\t", created.getSecGrpIncBuff() )
				+	"\n"
