 ...
 *	for SecGroup.
 */
public class CFSecXMsgRqstSecGroupRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupRdByClusterIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			String responseOpening = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecGroupMessageFormatter.formatSecGroupRspnListOpenTag();
			...
			while( iter.hasNext() ) {
				cur = iter.next();
				subxml = CFSecXMsgSecGroupMessageFormatter.formatSecGroupRspnDerivedRec( "\n\t\t", cur.getSecGroupBuff() );
				xmsgRqst.appendResponse( subxml );
			}
			String responseClosing =
				 	"\n"
				+	"\t" + CFSecXMsgSecGroupMessageFormatter.formatSecGroupRspnListCloseTag()
