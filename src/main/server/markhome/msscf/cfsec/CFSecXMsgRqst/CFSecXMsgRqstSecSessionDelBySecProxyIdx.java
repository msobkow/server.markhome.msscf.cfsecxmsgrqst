...
/*
 *	CFSecXMsgRqstSecSessionDelBy XML SAX Element  implementation
 *	for SecSession.
 */
public class CFSecXMsgRqstSecSessionDelBySecProxyIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecSessionDelBySecProxyIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
