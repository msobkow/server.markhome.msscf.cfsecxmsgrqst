...
/*
 *	CFSecXMsgRqstSecFormDelete XML SAX Element  implementation
 *	for SecForm.
 */
public class CFSecXMsgRqstSecFormDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecFormDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecSecFormObj read = ((ICFSecSecFormObj)schemaObj.getSecFormTableObj().readSecForm( pkey ));
			if( read != null ) {
				if( read.getSecFormBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecSecFormEditObj editBuff = (ICFSecSecFormEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFSecXMsgSecFormMessageFormatter.formatSecFormRspnDeleted() +	"\n"
