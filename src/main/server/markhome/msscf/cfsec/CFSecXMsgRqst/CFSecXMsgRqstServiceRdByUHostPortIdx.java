...
/*
 *	CFSecXMsgRqstServiceRdBy XML SAX Element  implementation
 *	for Service.
 */
public class CFSecXMsgRqstServiceRdByUHostPortIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceRdByUHostPortIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecServiceObj read = ((ICFSecServiceObj)schemaObj.getServiceTableObj().readServiceByUHostPortIdx( natClusterId,
				natHostNodeId,
				natHostPort,
				true ));
			if( read != null ) {
