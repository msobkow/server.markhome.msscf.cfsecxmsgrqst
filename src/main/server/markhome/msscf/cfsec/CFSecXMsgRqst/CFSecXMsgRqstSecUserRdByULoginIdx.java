...
/*
 *	CFSecXMsgRqstSecUserRdBy XML SAX Element  implementation
 *	for SecUser.
 */
public class CFSecXMsgRqstSecUserRdByULoginIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecUserRdByULoginIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecSecUserObj read = ((ICFSecSecUserObj)schemaObj.getSecUserTableObj().readSecUserByULoginIdx( natLoginId,
				true ));
			if( read != null ) {
