...
/*
 *	CFSecXMsgRqstTSecGroupCreate XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFSecXMsgRqstTSecGroupCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGroupCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecTSecGroupObj created = (ICFSecTSecGroupObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgTSecGroupMessageFormatter.formatTSecGroupRspnCreated( "\n\t\t\t", created.getTSecGroupBuff() )
				+	"\n"
