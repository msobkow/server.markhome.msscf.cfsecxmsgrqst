...
/*
 *	CFSecXMsgRqstHostNodePageBy XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRqstHostNodePageByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstHostNodePageByClusterIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
