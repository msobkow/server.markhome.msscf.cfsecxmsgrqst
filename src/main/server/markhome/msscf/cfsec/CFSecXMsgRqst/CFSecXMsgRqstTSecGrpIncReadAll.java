...
/*
 *	CFSecXMsgRqstTSecGrpIncReadAll XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFSecXMsgRqstTSecGrpIncReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGrpIncReadAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
