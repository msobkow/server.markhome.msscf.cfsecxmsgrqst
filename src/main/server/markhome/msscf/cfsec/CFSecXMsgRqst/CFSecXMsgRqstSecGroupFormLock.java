...
/*
 *	CFSecXMsgRqstSecGroupFormLock XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFSecXMsgRqstSecGroupFormLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupFormLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecGroupFormId( natSecGroupFormId );
			// Lock the object
			ICFSecSecGroupFormObj locked = ((ICFSecSecGroupFormObj)schemaObj.getSecGroupFormTableObj().lockSecGroupForm( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnLocked( "\n\t\t\t", locked.getSecGroupFormBuff() )
				+	"\n"
