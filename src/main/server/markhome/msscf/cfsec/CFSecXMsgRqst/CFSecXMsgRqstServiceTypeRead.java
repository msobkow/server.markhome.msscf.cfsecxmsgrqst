...
/*
 *	CFSecXMsgRqstServiceTypeRead XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFSecXMsgRqstServiceTypeRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceTypeRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecServiceTypeObj read = ((ICFSecServiceTypeObj)schemaObj.getServiceTypeTableObj().readServiceType( pkey, true ));
			if( read != null ) {
