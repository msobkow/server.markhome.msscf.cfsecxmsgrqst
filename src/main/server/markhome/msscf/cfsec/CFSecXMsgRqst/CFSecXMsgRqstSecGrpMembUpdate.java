...
/*
 *	CFSecXMsgRqstSecGrpMembUpdate XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFSecXMsgRqstSecGrpMembUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGrpMembUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFSecSecGrpMembObj origBuff = ((ICFSecSecGrpMembObj)schemaObj.getSecGrpMembTableObj().readSecGrpMemb( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecSecGrpMembEditObj editBuff = (ICFSecSecGrpMembEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecGrpMembMessageFormatter.formatSecGrpMembRspnUpdated( "\n\t\t\t", origBuff.getSecGrpMembBuff() )
					+	"\n"
