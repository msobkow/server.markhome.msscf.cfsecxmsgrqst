...
/*
 *	CFSecXMsgRqstISOTZoneRead XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFSecXMsgRqstISOTZoneRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOTZoneRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecISOTZonePKey pkey = ((ICFSecSchema)schemaObj.getBackingStore()).getFactoryISOTZone().newPKey();
			...
			ICFSecISOTZoneObj read = ((ICFSecISOTZoneObj)schemaObj.getISOTZoneTableObj().readISOTZone( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgISOTZoneMessageFormatter.formatISOTZoneRspnSingleOpenTag()
					+	CFSecXMsgISOTZoneMessageFormatter.formatISOTZoneRspnDerivedRec( "\n\t\t", read.getISOTZoneBuff() ) + "\n"
					+	"\t" + CFSecXMsgISOTZoneMessageFormatter.formatISOTZoneRspnSingleCloseTag()
