...
/*
 *	CFSecXMsgRqstISOCtryLangReadAll XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFSecXMsgRqstISOCtryLangReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCtryLangReadAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
