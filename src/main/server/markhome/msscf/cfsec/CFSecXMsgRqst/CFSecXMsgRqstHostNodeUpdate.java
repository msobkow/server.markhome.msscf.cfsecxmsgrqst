...
/*
 *	CFSecXMsgRqstHostNodeUpdate XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRqstHostNodeUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstHostNodeUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFSecHostNodeObj origBuff = ((ICFSecHostNodeObj)schemaObj.getHostNodeTableObj().readHostNode( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecHostNodeEditObj editBuff = (ICFSecHostNodeEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRspnUpdated( "\n\t\t\t", origBuff.getHostNodeBuff() )
					+	"\n"
