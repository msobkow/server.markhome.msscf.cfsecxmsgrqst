...
/*
 *	CFSecXMsgRqstISOTZoneDelete XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFSecXMsgRqstISOTZoneDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOTZoneDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecISOTZoneObj read = ((ICFSecISOTZoneObj)schemaObj.getISOTZoneTableObj().readISOTZone( pkey ));
			if( read != null ) {
				if( read.getISOTZoneBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecISOTZoneEditObj editBuff = (ICFSecISOTZoneEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFSecXMsgISOTZoneMessageFormatter.formatISOTZoneRspnDeleted() +	"\n"
