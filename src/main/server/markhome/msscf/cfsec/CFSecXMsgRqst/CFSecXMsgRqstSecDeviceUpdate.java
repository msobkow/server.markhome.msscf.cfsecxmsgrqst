...
/*
 *	CFSecXMsgRqstSecDeviceUpdate XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFSecXMsgRqstSecDeviceUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecDeviceUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSecDevicePKey pkey = ((ICFSecSchema)schemaObj.getBackingStore()).getFactorySecDevice().newPKey();
			...
			// Read the instance
			ICFSecSecDeviceObj origBuff = ((ICFSecSecDeviceObj)schemaObj.getSecDeviceTableObj().readSecDevice( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecSecDeviceEditObj editBuff = (ICFSecSecDeviceEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecDeviceMessageFormatter.formatSecDeviceRspnUpdated( "\n\t\t\t", origBuff.getSecDeviceBuff() )
					+	"\n"
