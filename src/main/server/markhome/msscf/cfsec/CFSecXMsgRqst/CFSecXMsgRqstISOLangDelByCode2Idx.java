...
/*
 *	CFSecXMsgRqstISOLangDelBy XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFSecXMsgRqstISOLangDelByCode2Idx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOLangDelByCode2Idx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
