...
/*
 *	CFSecXMsgRqstSysClusterDelete XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFSecXMsgRqstSysClusterDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSysClusterDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecSysClusterObj read = ((ICFSecSysClusterObj)schemaObj.getSysClusterTableObj().readSysCluster( pkey ));
			if( read != null ) {
				if( read.getSysClusterBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecSysClusterEditObj editBuff = (ICFSecSysClusterEditObj)read.beginEdit();
					if( editBuff != null ) {
