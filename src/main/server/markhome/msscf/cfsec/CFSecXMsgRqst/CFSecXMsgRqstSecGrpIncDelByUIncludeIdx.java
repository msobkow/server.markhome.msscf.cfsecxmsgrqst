...
/*
 *	CFSecXMsgRqstSecGrpIncDelBy XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFSecXMsgRqstSecGrpIncDelByUIncludeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGrpIncDelByUIncludeIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
