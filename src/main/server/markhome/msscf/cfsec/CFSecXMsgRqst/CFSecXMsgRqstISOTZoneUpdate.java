...
/*
 *	CFSecXMsgRqstISOTZoneUpdate XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFSecXMsgRqstISOTZoneUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOTZoneUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFSecISOTZoneObj origBuff = ((ICFSecISOTZoneObj)schemaObj.getISOTZoneTableObj().readISOTZone( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecISOTZoneEditObj editBuff = (ICFSecISOTZoneEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgISOTZoneMessageFormatter.formatISOTZoneRspnUpdated( "\n\t\t\t", origBuff.getISOTZoneBuff() )
					+	"\n"
