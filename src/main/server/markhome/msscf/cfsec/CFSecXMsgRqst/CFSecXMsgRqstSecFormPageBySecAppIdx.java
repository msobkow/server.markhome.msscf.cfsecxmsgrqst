...
/*
 *	CFSecXMsgRqstSecFormPageBy XML SAX Element  implementation
 *	for SecForm.
 */
public class CFSecXMsgRqstSecFormPageBySecAppIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecFormPageBySecAppIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			String responseOpening = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecFormMessageFormatter.formatSecFormRspnListOpenTag();
			...
			while( iter.hasNext() ) {
				cur = iter.next();
				subxml = CFSecXMsgSecFormMessageFormatter.formatSecFormRspnDerivedRec( "\n\t\t", cur.getSecFormBuff() );
				xmsgRqst.appendResponse( subxml );
			}
			String responseClosing =
				 	"\n"
				+	"\t" + CFSecXMsgSecFormMessageFormatter.formatSecFormRspnListCloseTag()
