...
/*
 *	CFSecXMsgRqstSecGrpMembPageBy XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFSecXMsgRqstSecGrpMembPageByGroupIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGrpMembPageByGroupIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			String responseOpening = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecGrpMembMessageFormatter.formatSecGrpMembRspnListOpenTag();
			...
			while( iter.hasNext() ) {
				cur = iter.next();
				subxml = CFSecXMsgSecGrpMembMessageFormatter.formatSecGrpMembRspnDerivedRec( "\n\t\t", cur.getSecGrpMembBuff() );
				xmsgRqst.appendResponse( subxml );
			}
			String responseClosing =
				 	"\n"
				+	"\t" + CFSecXMsgSecGrpMembMessageFormatter.formatSecGrpMembRspnListCloseTag()
