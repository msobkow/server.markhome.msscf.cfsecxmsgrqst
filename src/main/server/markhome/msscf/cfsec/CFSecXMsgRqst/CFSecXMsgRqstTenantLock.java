...
/*
 *	CFSecXMsgRqstTenantLock XML SAX Element  implementation
 *	for Tenant.
 */
public class CFSecXMsgRqstTenantLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTenantLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredId( natId );
			// Lock the object
			ICFSecTenantObj locked = ((ICFSecTenantObj)schemaObj.getTenantTableObj().lockTenant( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgTenantMessageFormatter.formatTenantRspnLocked( "\n\t\t\t", locked.getTenantBuff() )
				+	"\n"
