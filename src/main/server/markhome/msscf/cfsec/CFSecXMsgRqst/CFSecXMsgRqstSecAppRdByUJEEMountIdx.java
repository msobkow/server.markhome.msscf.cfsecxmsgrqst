...
/*
 *	CFSecXMsgRqstSecAppRdBy XML SAX Element  implementation
 *	for SecApp.
 */
public class CFSecXMsgRqstSecAppRdByUJEEMountIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecAppRdByUJEEMountIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecSecAppObj read = ((ICFSecSecAppObj)schemaObj.getSecAppTableObj().readSecAppByUJEEMountIdx( natClusterId,
				natJEEMountName,
				true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecAppMessageFormatter.formatSecAppRspnSingleOpenTag()
					+	CFSecXMsgSecAppMessageFormatter.formatSecAppRspnDerivedRec( "\n\t\t", read.getSecAppBuff() ) + "\n"
					+	"\t" + CFSecXMsgSecAppMessageFormatter.formatSecAppRspnSingleCloseTag()
