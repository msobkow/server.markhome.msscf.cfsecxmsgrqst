...
/*
 *	CFSecXMsgRqstServiceCreate XML SAX Element  implementation
 *	for Service.
 */
public class CFSecXMsgRqstServiceCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecServiceObj created = (ICFSecServiceObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgServiceMessageFormatter.formatServiceRspnCreated( "\n\t\t\t", created.getServiceBuff() )
				+	"\n"
