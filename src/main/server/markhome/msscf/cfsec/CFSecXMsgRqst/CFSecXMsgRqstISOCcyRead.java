...
/*
 *	CFSecXMsgRqstISOCcyRead XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFSecXMsgRqstISOCcyRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCcyRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecISOCcyPKey pkey = ((ICFSecSchema)schemaObj.getBackingStore()).getFactoryISOCcy().newPKey();
			...
			ICFSecISOCcyObj read = ((ICFSecISOCcyObj)schemaObj.getISOCcyTableObj().readISOCcy( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgISOCcyMessageFormatter.formatISOCcyRspnSingleOpenTag()
					+	CFSecXMsgISOCcyMessageFormatter.formatISOCcyRspnDerivedRec( "\n\t\t", read.getISOCcyBuff() ) + "\n"
					+	"\t" + CFSecXMsgISOCcyMessageFormatter.formatISOCcyRspnSingleCloseTag()
