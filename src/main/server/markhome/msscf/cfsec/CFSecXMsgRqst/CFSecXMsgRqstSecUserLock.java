...
/*
 *	CFSecXMsgRqstSecUserLock XML SAX Element  implementation
 *	for SecUser.
 */
public class CFSecXMsgRqstSecUserLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecUserLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecUserId( natSecUserId );
			// Lock the object
			ICFSecSecUserObj locked = ((ICFSecSecUserObj)schemaObj.getSecUserTableObj().lockSecUser( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecUserMessageFormatter.formatSecUserRspnLocked( "\n\t\t\t", locked.getSecUserBuff() )
				+	"\n"
