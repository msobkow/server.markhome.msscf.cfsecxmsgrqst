...
/*
 *	CFSecXMsgRqstISOCcyLock XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFSecXMsgRqstISOCcyLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCcyLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredISOCcyId( natISOCcyId );
			// Lock the object
			ICFSecISOCcyObj locked = ((ICFSecISOCcyObj)schemaObj.getISOCcyTableObj().lockISOCcy( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgISOCcyMessageFormatter.formatISOCcyRspnLocked( "\n\t\t\t", locked.getISOCcyBuff() )
				+	"\n"
