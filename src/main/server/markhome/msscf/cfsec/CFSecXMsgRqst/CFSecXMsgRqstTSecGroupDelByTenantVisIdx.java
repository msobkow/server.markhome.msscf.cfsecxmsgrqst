...
/*
 *	CFSecXMsgRqstTSecGroupDelBy XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFSecXMsgRqstTSecGroupDelByTenantVisIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGroupDelByTenantVisIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
