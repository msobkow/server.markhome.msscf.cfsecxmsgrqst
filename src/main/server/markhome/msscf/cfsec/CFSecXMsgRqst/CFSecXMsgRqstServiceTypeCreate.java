...
/*
 *	CFSecXMsgRqstServiceTypeCreate XML SAX Element  implementation
 *	for ServiceType.
 */
public class CFSecXMsgRqstServiceTypeCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceTypeCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecServiceTypeObj created = (ICFSecServiceTypeObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgServiceTypeMessageFormatter.formatServiceTypeRspnCreated( "\n\t\t\t", created.getServiceTypeBuff() )
				+	"\n"
