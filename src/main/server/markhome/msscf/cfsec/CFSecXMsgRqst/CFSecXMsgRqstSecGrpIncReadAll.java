...
/*
 *	CFSecXMsgRqstSecGrpIncReadAll XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFSecXMsgRqstSecGrpIncReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGrpIncReadAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
