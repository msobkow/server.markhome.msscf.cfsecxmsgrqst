...
/*
 *	CFSecXMsgRqstTSecGrpMembCreate XML SAX Element  implementation
 *	for TSecGrpMemb.
 */
public class CFSecXMsgRqstTSecGrpMembCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGrpMembCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecTSecGrpMembObj created = (ICFSecTSecGrpMembObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRspnCreated( "\n\t\t\t", created.getTSecGrpMembBuff() )
				+	"\n"
