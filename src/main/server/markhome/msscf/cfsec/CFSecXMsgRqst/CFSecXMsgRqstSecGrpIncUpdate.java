...
/*
 *	CFSecXMsgRqstSecGrpIncUpdate XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFSecXMsgRqstSecGrpIncUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGrpIncUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSecGrpIncPKey pkey = ((ICFSecSchema)schemaObj.getBackingStore()).getFactorySecGrpInc().newPKey();
			...
			// Read the instance
			ICFSecSecGrpIncObj origBuff = ((ICFSecSecGrpIncObj)schemaObj.getSecGrpIncTableObj().readSecGrpInc( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecSecGrpIncEditObj editBuff = (ICFSecSecGrpIncEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecGrpIncMessageFormatter.formatSecGrpIncRspnUpdated( "\n\t\t\t", origBuff.getSecGrpIncBuff() )
					+	"\n"
