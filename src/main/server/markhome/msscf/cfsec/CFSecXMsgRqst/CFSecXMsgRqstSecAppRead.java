...
/*
 *	CFSecXMsgRqstSecAppRead XML SAX Element  implementation
 *	for SecApp.
 */
public class CFSecXMsgRqstSecAppRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecAppRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecAppObj read = ((ICFSecSecAppObj)schemaObj.getSecAppTableObj().readSecApp( pkey, true ));
			if( read != null ) {
