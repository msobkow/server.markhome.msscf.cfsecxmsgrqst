...
/*
 *	CFSecXMsgRqstSecDeviceReadAll XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFSecXMsgRqstSecDeviceReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecDeviceReadAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
