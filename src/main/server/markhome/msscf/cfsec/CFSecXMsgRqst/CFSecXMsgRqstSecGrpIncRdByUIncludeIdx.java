...
/*
 *	CFSecXMsgRqstSecGrpIncRdBy XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFSecXMsgRqstSecGrpIncRdByUIncludeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGrpIncRdByUIncludeIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecSecGrpIncObj read = ((ICFSecSecGrpIncObj)schemaObj.getSecGrpIncTableObj().readSecGrpIncByUIncludeIdx( natClusterId,
				natSecGroupId,
				natIncludeGroupId,
				true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecGrpIncMessageFormatter.formatSecGrpIncRspnSingleOpenTag()
					+	CFSecXMsgSecGrpIncMessageFormatter.formatSecGrpIncRspnDerivedRec( "\n\t\t", read.getSecGrpIncBuff() ) + "\n"
					+	"\t" + CFSecXMsgSecGrpIncMessageFormatter.formatSecGrpIncRspnSingleCloseTag()
