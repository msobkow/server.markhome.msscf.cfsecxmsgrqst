...
/*
 *	CFSecXMsgRqstISOCtryCcyCreate XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFSecXMsgRqstISOCtryCcyCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCtryCcyCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecISOCtryCcyObj created = (ICFSecISOCtryCcyObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgISOCtryCcyMessageFormatter.formatISOCtryCcyRspnCreated( "\n\t\t\t", created.getISOCtryCcyBuff() )
				+	"\n"
