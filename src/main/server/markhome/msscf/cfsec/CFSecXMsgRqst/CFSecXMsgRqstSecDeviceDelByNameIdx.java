...
/*
 *	CFSecXMsgRqstSecDeviceDelBy XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFSecXMsgRqstSecDeviceDelByNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecDeviceDelByNameIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
