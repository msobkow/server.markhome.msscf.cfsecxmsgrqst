...
/*
 *	CFSecXMsgRqstSecFormLock XML SAX Element  implementation
 *	for SecForm.
 */
public class CFSecXMsgRqstSecFormLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecFormLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecFormId( natSecFormId );
			// Lock the object
			ICFSecSecFormObj locked = ((ICFSecSecFormObj)schemaObj.getSecFormTableObj().lockSecForm( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecFormMessageFormatter.formatSecFormRspnLocked( "\n\t\t\t", locked.getSecFormBuff() )
				+	"\n"
