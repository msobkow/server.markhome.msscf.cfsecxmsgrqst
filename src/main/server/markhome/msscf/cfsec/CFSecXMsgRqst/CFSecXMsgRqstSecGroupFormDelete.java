...
/*
 *	CFSecXMsgRqstSecGroupFormDelete XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFSecXMsgRqstSecGroupFormDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupFormDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecSecGroupFormObj read = ((ICFSecSecGroupFormObj)schemaObj.getSecGroupFormTableObj().readSecGroupForm( pkey ));
			if( read != null ) {
				if( read.getSecGroupFormBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecSecGroupFormEditObj editBuff = (ICFSecSecGroupFormEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFSecXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnDeleted() +	"\n"
