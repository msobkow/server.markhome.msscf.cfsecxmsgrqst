...
/*
 *	CFSecXMsgRqstISOCcyUpdate XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFSecXMsgRqstISOCcyUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCcyUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFSecISOCcyObj origBuff = ((ICFSecISOCcyObj)schemaObj.getISOCcyTableObj().readISOCcy( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecISOCcyEditObj editBuff = (ICFSecISOCcyEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgISOCcyMessageFormatter.formatISOCcyRspnUpdated( "\n\t\t\t", origBuff.getISOCcyBuff() )
					+	"\n"
