...
/*
 *	CFSecXMsgRqstSecUserReadAll XML SAX Element  implementation
 *	for SecUser.
 */
public class CFSecXMsgRqstSecUserReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecUserReadAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
