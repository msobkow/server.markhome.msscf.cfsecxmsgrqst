...
/*
 *	CFSecXMsgRqstISOCtryCcyLock XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFSecXMsgRqstISOCtryCcyLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCtryCcyLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredISOCcyId( natISOCcyId );
			// Lock the object
			ICFSecISOCtryCcyObj locked = ((ICFSecISOCtryCcyObj)schemaObj.getISOCtryCcyTableObj().lockISOCtryCcy( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgISOCtryCcyMessageFormatter.formatISOCtryCcyRspnLocked( "\n\t\t\t", locked.getISOCtryCcyBuff() )
				+	"\n"
