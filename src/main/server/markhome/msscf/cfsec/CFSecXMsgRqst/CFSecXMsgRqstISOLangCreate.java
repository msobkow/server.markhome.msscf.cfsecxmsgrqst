...
/*
 *	CFSecXMsgRqstISOLangCreate XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFSecXMsgRqstISOLangCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOLangCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecISOLangObj created = (ICFSecISOLangObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgISOLangMessageFormatter.formatISOLangRspnCreated( "\n\t\t\t", created.getISOLangBuff() )
				+	"\n"
