...
/*
 *	CFSecXMsgRqstTenantRdBy XML SAX Element  implementation
 *	for Tenant.
 */
public class CFSecXMsgRqstTenantRdByUNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTenantRdByUNameIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecTenantObj read = ((ICFSecTenantObj)schemaObj.getTenantTableObj().readTenantByUNameIdx( natClusterId,
				natTenantName,
				true ));
			if( read != null ) {
