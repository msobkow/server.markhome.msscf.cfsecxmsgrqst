...
/*
 *	CFSecXMsgRqstSysClusterRead XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFSecXMsgRqstSysClusterRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSysClusterRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSysClusterObj read = ((ICFSecSysClusterObj)schemaObj.getSysClusterTableObj().readSysCluster( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSysClusterMessageFormatter.formatSysClusterRspnSingleOpenTag()
					+	CFSecXMsgSysClusterMessageFormatter.formatSysClusterRspnDerivedRec( "\n\t\t", read.getSysClusterBuff() ) + "\n"
					+	"\t" + CFSecXMsgSysClusterMessageFormatter.formatSysClusterRspnSingleCloseTag()
