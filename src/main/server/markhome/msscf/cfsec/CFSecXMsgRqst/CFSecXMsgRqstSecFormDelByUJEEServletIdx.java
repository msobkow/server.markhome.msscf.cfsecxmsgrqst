...
/*
 *	CFSecXMsgRqstSecFormDelBy XML SAX Element  implementation
 *	for SecForm.
 */
public class CFSecXMsgRqstSecFormDelByUJEEServletIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecFormDelByUJEEServletIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
