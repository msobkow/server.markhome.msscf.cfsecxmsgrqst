...
/*
 *	CFSecXMsgRqstServiceReadAll XML SAX Element  implementation
 *	for Service.
 */
public class CFSecXMsgRqstServiceReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceReadAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
