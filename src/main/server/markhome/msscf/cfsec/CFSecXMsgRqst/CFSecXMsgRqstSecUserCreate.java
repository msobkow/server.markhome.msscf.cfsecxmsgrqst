...
/*
 *	CFSecXMsgRqstSecUserCreate XML SAX Element  implementation
 *	for SecUser.
 */
public class CFSecXMsgRqstSecUserCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecUserCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecUserObj created = (ICFSecSecUserObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecUserMessageFormatter.formatSecUserRspnCreated( "\n\t\t\t", created.getSecUserBuff() )
				+	"\n"
