...
/*
 *	CFSecXMsgRqstSecSessionDelete XML SAX Element  implementation
 *	for SecSession.
 */
public class CFSecXMsgRqstSecSessionDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecSessionDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecSecSessionObj read = ((ICFSecSecSessionObj)schemaObj.getSecSessionTableObj().readSecSession( pkey ));
			if( read != null ) {
				if( read.getSecSessionBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecSecSessionEditObj editBuff = (ICFSecSecSessionEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFSecXMsgSecSessionMessageFormatter.formatSecSessionRspnDeleted() +	"\n"
