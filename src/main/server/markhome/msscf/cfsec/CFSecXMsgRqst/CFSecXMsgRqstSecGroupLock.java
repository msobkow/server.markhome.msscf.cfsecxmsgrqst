...
/*
 *	CFSecXMsgRqstSecGroupLock XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFSecXMsgRqstSecGroupLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecGroupId( natSecGroupId );
			// Lock the object
			ICFSecSecGroupObj locked = ((ICFSecSecGroupObj)schemaObj.getSecGroupTableObj().lockSecGroup( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecGroupMessageFormatter.formatSecGroupRspnLocked( "\n\t\t\t", locked.getSecGroupBuff() )
				+	"\n"
