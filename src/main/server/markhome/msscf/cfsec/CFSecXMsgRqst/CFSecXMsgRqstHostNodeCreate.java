...
/*
 *	CFSecXMsgRqstHostNodeCreate XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRqstHostNodeCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstHostNodeCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecHostNodeObj created = (ICFSecHostNodeObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRspnCreated( "\n\t\t\t", created.getHostNodeBuff() )
				+	"\n"
