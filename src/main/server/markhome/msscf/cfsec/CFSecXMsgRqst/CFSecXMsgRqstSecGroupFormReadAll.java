...
/*
 *	CFSecXMsgRqstSecGroupFormReadAll XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFSecXMsgRqstSecGroupFormReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupFormReadAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
