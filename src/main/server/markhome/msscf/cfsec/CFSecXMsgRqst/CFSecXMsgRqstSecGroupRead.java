...
/*
 *	CFSecXMsgRqstSecGroupRead XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFSecXMsgRqstSecGroupRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecGroupObj read = ((ICFSecSecGroupObj)schemaObj.getSecGroupTableObj().readSecGroup( pkey, true ));
			if( read != null ) {
