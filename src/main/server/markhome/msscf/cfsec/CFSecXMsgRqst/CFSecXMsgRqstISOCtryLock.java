...
/*
 *	CFSecXMsgRqstISOCtryLock XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFSecXMsgRqstISOCtryLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCtryLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredISOCtryId( natISOCtryId );
			// Lock the object
			ICFSecISOCtryObj locked = ((ICFSecISOCtryObj)schemaObj.getISOCtryTableObj().lockISOCtry( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgISOCtryMessageFormatter.formatISOCtryRspnLocked( "\n\t\t\t", locked.getISOCtryBuff() )
				+	"\n"
