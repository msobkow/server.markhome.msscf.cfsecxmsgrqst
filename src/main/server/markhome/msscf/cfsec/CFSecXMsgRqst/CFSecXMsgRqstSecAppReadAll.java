...
/*
 *	CFSecXMsgRqstSecAppReadAll XML SAX Element  implementation
 *	for SecApp.
 */
public class CFSecXMsgRqstSecAppReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecAppReadAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
