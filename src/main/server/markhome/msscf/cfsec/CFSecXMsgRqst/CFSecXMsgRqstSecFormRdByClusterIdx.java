...
/*
 *	CFSecXMsgRqstSecFormRdBy XML SAX Element  implementation
 *	for SecForm.
 */
public class CFSecXMsgRqstSecFormRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecFormRdByClusterIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
