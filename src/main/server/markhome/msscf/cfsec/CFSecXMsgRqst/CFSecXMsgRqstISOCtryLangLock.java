...
/*
 *	CFSecXMsgRqstISOCtryLangLock XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFSecXMsgRqstISOCtryLangLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCtryLangLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredISOLangId( natISOLangId );
			// Lock the object
			ICFSecISOCtryLangObj locked = ((ICFSecISOCtryLangObj)schemaObj.getISOCtryLangTableObj().lockISOCtryLang( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgISOCtryLangMessageFormatter.formatISOCtryLangRspnLocked( "\n\t\t\t", locked.getISOCtryLangBuff() )
				+	"\n"
