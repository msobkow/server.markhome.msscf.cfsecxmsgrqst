...
/*
 *	CFSecXMsgRqstSecFormUpdate XML SAX Element  implementation
 *	for SecForm.
 */
public class CFSecXMsgRqstSecFormUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecFormUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSecFormPKey pkey = ((ICFSecSchema)schemaObj.getBackingStore()).getFactorySecForm().newPKey();
			...
			// Read the instance
			ICFSecSecFormObj origBuff = ((ICFSecSecFormObj)schemaObj.getSecFormTableObj().readSecForm( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecSecFormEditObj editBuff = (ICFSecSecFormEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecFormMessageFormatter.formatSecFormRspnUpdated( "\n\t\t\t", origBuff.getSecFormBuff() )
					+	"\n"
