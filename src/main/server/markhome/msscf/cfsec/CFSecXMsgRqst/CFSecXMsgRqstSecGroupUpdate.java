...
/*
 *	CFSecXMsgRqstSecGroupUpdate XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFSecXMsgRqstSecGroupUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFSecSecGroupObj origBuff = ((ICFSecSecGroupObj)schemaObj.getSecGroupTableObj().readSecGroup( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecSecGroupEditObj editBuff = (ICFSecSecGroupEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecGroupMessageFormatter.formatSecGroupRspnUpdated( "\n\t\t\t", origBuff.getSecGroupBuff() )
					+	"\n"
