...
/*
 *	CFSecXMsgRqstSecSessionRead XML SAX Element  implementation
 *	for SecSession.
 */
public class CFSecXMsgRqstSecSessionRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecSessionRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecSessionObj read = ((ICFSecSecSessionObj)schemaObj.getSecSessionTableObj().readSecSession( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecSessionMessageFormatter.formatSecSessionRspnSingleOpenTag()
					+	CFSecXMsgSecSessionMessageFormatter.formatSecSessionRspnDerivedRec( "\n\t\t", read.getSecSessionBuff() ) + "\n"
					+	"\t" + CFSecXMsgSecSessionMessageFormatter.formatSecSessionRspnSingleCloseTag()
