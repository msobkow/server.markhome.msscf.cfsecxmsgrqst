...
/*
 *	CFSecXMsgRqstSecGroupFormCreate XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFSecXMsgRqstSecGroupFormCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupFormCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecGroupFormObj created = (ICFSecSecGroupFormObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecGroupFormMessageFormatter.formatSecGroupFormRspnCreated( "\n\t\t\t", created.getSecGroupFormBuff() )
				+	"\n"
