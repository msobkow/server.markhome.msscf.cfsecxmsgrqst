...
/*
 *	CFSecXMsgRqstHostNodeRdBy XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRqstHostNodeRdByHostNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstHostNodeRdByHostNameIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecHostNodeObj read = ((ICFSecHostNodeObj)schemaObj.getHostNodeTableObj().readHostNodeByHostNameIdx( natClusterId,
				natHostName,
				true ));
			if( read != null ) {
