...
/*
 *	CFSecXMsgRqstISOCtryLangDelete XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFSecXMsgRqstISOCtryLangDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOCtryLangDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecISOCtryLangObj read = ((ICFSecISOCtryLangObj)schemaObj.getISOCtryLangTableObj().readISOCtryLang( pkey ));
			if( read != null ) {
				if( read.getISOCtryLangBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecISOCtryLangEditObj editBuff = (ICFSecISOCtryLangEditObj)read.beginEdit();
					if( editBuff != null ) {
