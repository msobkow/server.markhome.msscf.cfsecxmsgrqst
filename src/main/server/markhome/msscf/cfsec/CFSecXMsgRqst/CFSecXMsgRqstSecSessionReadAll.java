...
/*
 *	CFSecXMsgRqstSecSessionReadAll XML SAX Element  implementation
 *	for SecSession.
 */
public class CFSecXMsgRqstSecSessionReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecSessionReadAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
