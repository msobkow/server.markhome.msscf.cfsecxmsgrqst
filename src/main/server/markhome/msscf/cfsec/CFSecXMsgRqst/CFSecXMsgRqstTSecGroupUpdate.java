...
/*
 *	CFSecXMsgRqstTSecGroupUpdate XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFSecXMsgRqstTSecGroupUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGroupUpdate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFSecTSecGroupObj origBuff = ((ICFSecTSecGroupObj)schemaObj.getTSecGroupTableObj().readTSecGroup( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFSecTSecGroupEditObj editBuff = (ICFSecTSecGroupEditObj)origBuff.beginEdit();
			...
			if( updatedAt != null ) {
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgTSecGroupMessageFormatter.formatTSecGroupRspnUpdated( "\n\t\t\t", origBuff.getTSecGroupBuff() )
					+	"\n"
