 ...
 *	for HostNode.
 */
public class CFSecXMsgRqstHostNodeRdByUDescrIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstHostNodeRdByUDescrIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecHostNodeObj read = ((ICFSecHostNodeObj)schemaObj.getHostNodeTableObj().readHostNodeByUDescrIdx( natClusterId,
				natDescription,
				true ));
			if( read != null ) {
