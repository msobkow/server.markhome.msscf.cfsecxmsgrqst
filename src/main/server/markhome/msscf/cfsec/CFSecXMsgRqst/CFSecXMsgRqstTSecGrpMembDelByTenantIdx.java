...
/*
 *	CFSecXMsgRqstTSecGrpMembDelBy XML SAX Element  implementation
 *	for TSecGrpMemb.
 */
public class CFSecXMsgRqstTSecGrpMembDelByTenantIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGrpMembDelByTenantIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
