...
/*
 *	CFSecXMsgRqstSecAppCreate XML SAX Element  implementation
 *	for SecApp.
 */
public class CFSecXMsgRqstSecAppCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecAppCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecAppObj created = (ICFSecSecAppObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecAppMessageFormatter.formatSecAppRspnCreated( "\n\t\t\t", created.getSecAppBuff() )
				+	"\n"
