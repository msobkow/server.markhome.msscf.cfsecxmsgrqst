...
/*
 *	CFSecXMsgRqstTSecGrpIncCreate XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFSecXMsgRqstTSecGrpIncCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGrpIncCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecTSecGrpIncObj created = (ICFSecTSecGrpIncObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRspnCreated( "\n\t\t\t", created.getTSecGrpIncBuff() )
				+	"\n"
