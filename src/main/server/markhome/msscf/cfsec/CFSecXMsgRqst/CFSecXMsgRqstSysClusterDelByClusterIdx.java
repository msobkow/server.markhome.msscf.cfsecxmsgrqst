...
/*
 *	CFSecXMsgRqstSysClusterDelBy XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFSecXMsgRqstSysClusterDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSysClusterDelByClusterIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSysClusterMessageFormatter.formatSysClusterRspnDeleted() +	"\n"
