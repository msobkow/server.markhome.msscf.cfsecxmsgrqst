...
/*
 *	CFSecXMsgRqstISOTZoneDelBy XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFSecXMsgRqstISOTZoneDelByUTZNameIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstISOTZoneDelByUTZNameIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
