...
/*
 *	CFSecXMsgRqstSecDevicePageAll XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFSecXMsgRqstSecDevicePageAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecDevicePageAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
