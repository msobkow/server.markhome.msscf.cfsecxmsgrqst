...
/*
 *	CFSecXMsgRqstServiceDelBy XML SAX Element  implementation
 *	for Service.
 */
public class CFSecXMsgRqstServiceDelByUHostPortIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceDelByUHostPortIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
