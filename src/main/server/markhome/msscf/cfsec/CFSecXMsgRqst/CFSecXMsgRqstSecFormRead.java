...
/*
 *	CFSecXMsgRqstSecFormRead XML SAX Element  implementation
 *	for SecForm.
 */
public class CFSecXMsgRqstSecFormRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecFormRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecFormObj read = ((ICFSecSecFormObj)schemaObj.getSecFormTableObj().readSecForm( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecFormMessageFormatter.formatSecFormRspnSingleOpenTag()
					+	CFSecXMsgSecFormMessageFormatter.formatSecFormRspnDerivedRec( "\n\t\t", read.getSecFormBuff() ) + "\n"
					+	"\t" + CFSecXMsgSecFormMessageFormatter.formatSecFormRspnSingleCloseTag()
