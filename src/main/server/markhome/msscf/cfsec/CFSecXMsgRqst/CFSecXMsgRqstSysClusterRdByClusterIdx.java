...
/*
 *	CFSecXMsgRqstSysClusterRdBy XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFSecXMsgRqstSysClusterRdByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSysClusterRdByClusterIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			String responseOpening = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSysClusterMessageFormatter.formatSysClusterRspnListOpenTag();
			...
			while( iter.hasNext() ) {
				cur = iter.next();
				subxml = CFSecXMsgSysClusterMessageFormatter.formatSysClusterRspnDerivedRec( "\n\t\t", cur.getSysClusterBuff() );
				xmsgRqst.appendResponse( subxml );
			}
			String responseClosing =
				 	"\n"
				+	"\t" + CFSecXMsgSysClusterMessageFormatter.formatSysClusterRspnListCloseTag()
