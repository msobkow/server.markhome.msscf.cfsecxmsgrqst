...
/*
 *	CFSecXMsgRqstSecUserDelete XML SAX Element  implementation
 *	for SecUser.
 */
public class CFSecXMsgRqstSecUserDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecUserDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecSecUserObj read = ((ICFSecSecUserObj)schemaObj.getSecUserTableObj().readSecUser( pkey ));
			if( read != null ) {
				if( read.getSecUserBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecSecUserEditObj editBuff = (ICFSecSecUserEditObj)read.beginEdit();
					if( editBuff != null ) {
