...
/*
 *	CFSecXMsgRqstHostNodeRead XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRqstHostNodeRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstHostNodeRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecHostNodePKey pkey = ((ICFSecSchema)schemaObj.getBackingStore()).getFactoryHostNode().newPKey();
			...
			ICFSecHostNodeObj read = ((ICFSecHostNodeObj)schemaObj.getHostNodeTableObj().readHostNode( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRspnSingleOpenTag()
					+	CFSecXMsgHostNodeMessageFormatter.formatHostNodeRspnDerivedRec( "\n\t\t", read.getHostNodeBuff() ) + "\n"
					+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRspnSingleCloseTag()
