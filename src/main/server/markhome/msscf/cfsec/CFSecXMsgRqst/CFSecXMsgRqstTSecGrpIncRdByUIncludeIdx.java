...
/*
 *	CFSecXMsgRqstTSecGrpIncRdBy XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFSecXMsgRqstTSecGrpIncRdByUIncludeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTSecGrpIncRdByUIncludeIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecTSecGrpIncObj read = ((ICFSecTSecGrpIncObj)schemaObj.getTSecGrpIncTableObj().readTSecGrpIncByUIncludeIdx( natTenantId,
				natTSecGroupId,
				natIncludeGroupId,
				true ));
			if( read != null ) {
