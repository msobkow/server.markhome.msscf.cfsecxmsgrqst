...
/*
 *	CFSecXMsgRqstSecSessionLock XML SAX Element  implementation
 *	for SecSession.
 */
public class CFSecXMsgRqstSecSessionLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecSessionLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredSecSessionId( natSecSessionId );
			// Lock the object
			ICFSecSecSessionObj locked = ((ICFSecSecSessionObj)schemaObj.getSecSessionTableObj().lockSecSession( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecSessionMessageFormatter.formatSecSessionRspnLocked( "\n\t\t\t", locked.getSecSessionBuff() )
				+	"\n"
