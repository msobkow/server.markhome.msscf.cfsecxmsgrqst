...
/*
 *	CFSecXMsgRqstLogOut XML SAX Element  implementation
 */
public class CFSecXMsgRqstLogOut
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstLogOut( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSchemaMessageFormatter.formatRspnLoggedOut( "\n\t\t\t",
								secSessionId ) +	"\n"
