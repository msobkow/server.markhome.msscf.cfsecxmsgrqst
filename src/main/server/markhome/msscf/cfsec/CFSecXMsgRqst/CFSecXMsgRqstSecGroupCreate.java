...
/*
 *	CFSecXMsgRqstSecGroupCreate XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFSecXMsgRqstSecGroupCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecSecGroupObj created = (ICFSecSecGroupObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecGroupMessageFormatter.formatSecGroupRspnCreated( "\n\t\t\t", created.getSecGroupBuff() )
				+	"\n"
