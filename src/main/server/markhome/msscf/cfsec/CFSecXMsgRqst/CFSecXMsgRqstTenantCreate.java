...
/*
 *	CFSecXMsgRqstTenantCreate XML SAX Element  implementation
 *	for Tenant.
 */
public class CFSecXMsgRqstTenantCreate
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstTenantCreate( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			ICFSecTenantEditObj editBuff = (ICFSecTenantEditObj)schemaObj.getTenantTableObj().newInstance().beginEdit();
			...
			ICFSecTenantObj created = (ICFSecTenantObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgTenantMessageFormatter.formatTenantRspnCreated( "\n\t\t\t", created.getTenantBuff() )
				+	"\n"
