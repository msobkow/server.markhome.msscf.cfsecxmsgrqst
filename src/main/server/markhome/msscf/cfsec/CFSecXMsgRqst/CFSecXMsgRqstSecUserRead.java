...
/*
 *	CFSecXMsgRqstSecUserRead XML SAX Element  implementation
 *	for SecUser.
 */
public class CFSecXMsgRqstSecUserRead
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecUserRead( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFSecSecUserPKey pkey = ((ICFSecSchema)schemaObj.getBackingStore()).getFactorySecUser().newPKey();
			...
			ICFSecSecUserObj read = ((ICFSecSecUserObj)schemaObj.getSecUserTableObj().readSecUser( pkey, true ));
			if( read != null ) {
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFSecXMsgSecUserMessageFormatter.formatSecUserRspnSingleOpenTag()
					+	CFSecXMsgSecUserMessageFormatter.formatSecUserRspnDerivedRec( "\n\t\t", read.getSecUserBuff() ) + "\n"
					+	"\t" + CFSecXMsgSecUserMessageFormatter.formatSecUserRspnSingleCloseTag()
