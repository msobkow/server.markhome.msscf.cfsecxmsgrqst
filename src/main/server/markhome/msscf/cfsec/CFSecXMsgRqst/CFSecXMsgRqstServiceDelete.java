...
/*
 *	CFSecXMsgRqstServiceDelete XML SAX Element  implementation
 *	for Service.
 */
public class CFSecXMsgRqstServiceDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecServiceObj read = ((ICFSecServiceObj)schemaObj.getServiceTableObj().readService( pkey ));
			if( read != null ) {
				if( read.getServiceBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecServiceEditObj editBuff = (ICFSecServiceEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFSecXMsgServiceMessageFormatter.formatServiceRspnDeleted() +	"\n"
