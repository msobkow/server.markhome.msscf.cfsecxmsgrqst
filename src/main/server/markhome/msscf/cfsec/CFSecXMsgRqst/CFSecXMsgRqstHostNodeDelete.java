...
/*
 *	CFSecXMsgRqstHostNodeDelete XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRqstHostNodeDelete
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstHostNodeDelete( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Delete the object
			ICFSecHostNodeObj read = ((ICFSecHostNodeObj)schemaObj.getHostNodeTableObj().readHostNode( pkey ));
			if( read != null ) {
				if( read.getHostNodeBuff().getRequiredRevision() > natRevision ) {
					...
					ICFSecHostNodeEditObj editBuff = (ICFSecHostNodeEditObj)read.beginEdit();
					if( editBuff != null ) {
						editBuff.deleteInstance();
						editBuff = null;
						String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
							+	"\t" + CFSecXMsgHostNodeMessageFormatter.formatHostNodeRspnDeleted() +	"\n"
