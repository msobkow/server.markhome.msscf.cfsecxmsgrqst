...
/*
 *	CFSecXMsgRqstSecGroupFormDelBy XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFSecXMsgRqstSecGroupFormDelByClusterIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecGroupFormDelByClusterIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
