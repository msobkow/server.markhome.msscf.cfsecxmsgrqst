 ...
 *	for Service.
 */
public class CFSecXMsgRqstServiceRdByUTypeIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstServiceRdByUTypeIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the object
			ICFSecServiceObj read = ((ICFSecServiceObj)schemaObj.getServiceTableObj().readServiceByUTypeIdx( natClusterId,
				natHostNodeId,
				natServiceTypeId,
				true ));
			if( read != null ) {
