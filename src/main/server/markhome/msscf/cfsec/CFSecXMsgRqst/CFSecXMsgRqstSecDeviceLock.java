...
/*
 *	CFSecXMsgRqstSecDeviceLock XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFSecXMsgRqstSecDeviceLock
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecDeviceLock( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredDevName( natDevName );
			// Lock the object
			ICFSecSecDeviceObj locked = ((ICFSecSecDeviceObj)schemaObj.getSecDeviceTableObj().lockSecDevice( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFSecXMsgSecDeviceMessageFormatter.formatSecDeviceRspnLocked( "\n\t\t\t", locked.getSecDeviceBuff() )
				+	"\n"
