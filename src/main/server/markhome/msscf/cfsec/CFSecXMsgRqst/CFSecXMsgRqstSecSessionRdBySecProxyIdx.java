...
/*
 *	CFSecXMsgRqstSecSessionRdBy XML SAX Element  implementation
 *	for SecSession.
 */
public class CFSecXMsgRqstSecSessionRdBySecProxyIdx
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstSecSessionRdBySecProxyIdx( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
