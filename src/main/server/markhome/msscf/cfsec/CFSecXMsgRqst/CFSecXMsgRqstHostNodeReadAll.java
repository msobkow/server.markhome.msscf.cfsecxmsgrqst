...
/*
 *	CFSecXMsgRqstHostNodeReadAll XML SAX Element  implementation
 *	for HostNode.
 */
public class CFSecXMsgRqstHostNodeReadAll
	extends CFLibXmlCoreElementHandler
{
	public CFSecXMsgRqstHostNodeReadAll( CFSecXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
